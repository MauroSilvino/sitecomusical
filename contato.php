<html>
    ...
    <div class="nav-wrapper black">
      ...
      <div class="row black ">
        <div class=" col s12 m6 l12 capa"> 
          <h1> Entre em contato conosco!</h1>
          <h4> Você pode entre em contato por Whatsapp.<h4>
          <h6 class="subt"> Veja nesta página nosso Contato: </h6>
          <div class="col s12 m12 l12 black alinha">
            <p> A iniciativa Co. Musical se inicia na cidade do Rio de Janeiro Capital. Você pode falar com um de seus fundadores pelo Telefone e Whatsapp (21) 98198 1510 - Mauro. O planejamento é, após o período de pandemia do COVID seja feita a expansão para outras cidades, alcançando um maoir número de artistas, músicos e produtores.</p>   
        </div>
    </div>
