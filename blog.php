    ...
    <div class="nav-wrapper black">
      ...
      <div class="row black ">
        <div class=" col s12 m6 l12 capa"> 
          ...
          <h4> Artistas, Notícias e Entretenimento.<h4>
          <h6 class="subt"> Veja nesta página nosso Blog: </h6>
          <div class="col s12 m12 l12 black alinha">
            <p> Fique por dentro do cenário musical e atualizado sobre seus artistas favoritos tanto brasileiros quanto internacionais. Notícias sobre músicas, os novos lançamentos e muito mais, tudo no nosso Blog.</p>
