    ...
    <div class="nav-wrapper black">
      ...
      <div class="row black ">
        <div class=" col s12 m6 l12 capa"> 
          <h1> Este é nosso Calendário!</h1>
          <h4> Ensaios, Shows e Lançamentos.<h4>
          <h6 class="subt"> Veja nesta página nosso Calendário: </h6>
          <div class="col s12 m12 l12 black alinha">
            <p> Ainda não temos eventos marcados em virtude da epidemia de COVID, em breve publicaremos as datas de nossos futuros eventos nesta página. Nos curto, nos siga e inscreva-se para ficar sempre por dentro das datas de nossos eventos.</p>     
        </div>
     </div>
